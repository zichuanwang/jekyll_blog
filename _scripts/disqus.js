<script>
// Disqus
var disqus_shortname = 'zichuanwang';
if (!window.disqus_url) window.disqus_url = "http://zichuanwang.com{{ page.url }}";
...
<script async src="http://disqus.com/forums/zichuanwang/count.js"></script>
